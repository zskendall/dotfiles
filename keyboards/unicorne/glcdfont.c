...
const unsigned char font[] PROGMEM = {
  // start first row (symbols and arrows)
  ...
  // start second row (symbols and numbers)
  0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
  ...
  // start third row (capital letters)
  ...
  // start fourth row (lowercase letters)
