...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_QWERTY] = LAYOUT(
        ...
        KC_LGUI, KC_Z, KC_X, KC_C, KC_V, KC_B,                        KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_MINS,
                        KC_LSPO, LALT_SPC, NUM_LB,                NAV_RB, RALT_RET, KC_RSPC
    ),
     ...
     */
    [_NUM] = LAYOUT(
        _____, __x__, __x__, _____, KC_GRV, KC_UNDS,                    KC_PAST, KC_7 , KC_8 , KC_9  , KC_MINS, KC_DEL,
        _____, _____, __x__, _____, _____ , KC_BSLS,                    KC_PSLS, KC_4 , KC_5 , KC_6  , KC_PPLS, _____  ,
        _____, __x__, __x__, _____, __x__ , _____  ,                    KC_EQL , KC_1 , KC_2 , KC_3  , KC_DOT , _____  ,
